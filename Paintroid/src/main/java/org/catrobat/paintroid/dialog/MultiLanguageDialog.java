...
public class MultiLanguageDialog extends DialogFragment implements View.OnClickListener, DialogInterface.OnClickListener {
    ...
    Locale mLocale;
    Intent intent;
    RadioButton choiceArabic;
    RadioButton choiceEnglish;
    RadioButton choiceGerman;
    RadioButton choiceSwedish;
    RadioButton choiceFRENCH;
    RadioButton choiceITALIAN;
    RadioButton choiceSPANISH;
    RadioButton choiceHUNGARIAN;
    RadioButton choiceJAPANESE;
    RadioButton choicePOLISH;
    RadioButton choicePERSIAN;
    RadioButton choicePORTUGUESE;
    RadioButton choiceTURKISH;
    RadioButton choiceRUSSIAN;
