...
public class BrushPickerDialogLocalizationTest extends BaseIntegrationTestClass {
    ...
    public void testViewsTextDirection() {
        ...
        assertEquals("The Direction of Stroke TextView is Left-to-Right", mWidthTextView .getTextDirection(), expected);
        assertEquals("The Direction of Shape TextView is Left-to-Right", mStrokeTextView .getTextDirection(), expected);
        mSolo.goBack();
    }
    ...
    public void testSeekBarRTLDirection() {
        ...
        assertEquals("The Direction of Stroke TextView is Left-to-Right", mStrokeWidthSeekBar.getLayoutDirection(),expected);
    }
    ...
    public void testSeekBarMarginForRTL() {
        ...
        assertNotNull("There is no MarginStart for RTL", params.getMarginStart());
        assertNotNull("There is no MarginStart for RTL", params.getMarginEnd());
        mSolo.goBack();
    }
    ...
    public void testRadioButtonMarginRTL() {
        ...
        assertNotNull("There is no MarginEnd for RTL Layout", params1.getMarginEnd());
        assertNotNull("There is no MarginEnd for RTL Layout", params2.getMarginStart());
        assertNotNull("There is no MarginEnd for RTL layout", params2.getMarginEnd());
        mSolo.goBack();
    }
    ...
    public void testTextDirection()
    {
        ...
        mWidthTextView = (TextView) mSolo.getView(R.id.stroke_width_text);
        final int expected=View.TEXT_DIRECTION_LOCALE;
        assertEquals(mStrokeTextView.getTextDirection(),expected);
        assertEquals(mWidthTextView.getTextDirection(),expected);
