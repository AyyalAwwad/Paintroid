...
//the test method verify that a View is displayed correctly
    ...
    public void testViewToolsLayout() {
    ...
    public void testTextRTLDirection() {
        mSolo.clickOnView(mMenuBottomTool);
        mSolo.sleep(2000);
        TextView mTextView = (TextView) mSolo.getView(R.id.tool_button_text);
        // The paragraph direction of this view is Right to Left. Constant Value: 1
        assertEquals("The Text Direction is Left to right", mTextView.getLayoutDirection(), 1);
    }
    ...
    public void testOverLapping()
    {
        ...
        TextView mTextView = (TextView) mSolo.getView(R.id.tool_button_text);
        ImageView mImageView=(ImageView) mSolo.getView(R.id.tool_button_image);
        assertTrue("Image should be right of Text",mTextView.getRight()<= mImageView.getLeft());
    }
}
