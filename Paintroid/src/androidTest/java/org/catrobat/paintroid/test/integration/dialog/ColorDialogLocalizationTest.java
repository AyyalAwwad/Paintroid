...
public class ColorDialogLocalizationTest extends BaseIntegrationTestClass {
    ...
    public void testRedJustification()
    {
        mSolo.clickOnView(mButtonTopColor);
        mSolo.sleep(2000);
        TabHost tabHost = (TabHost) mSolo.getView(R.id.colorview_tabColors);
    ...
    public void testGreenJustification()
    {
        mSolo.clickOnView(mButtonTopColor);
        mSolo.sleep(2000);
        TabHost tabHost = (TabHost) mSolo.getView(R.id.colorview_tabColors);
    ...
    public void testBlueJustification()
    {
        mSolo.clickOnView(mButtonTopColor);
        mSolo.sleep(2000);
        TabHost tabHost = (TabHost) mSolo.getView(R.id.colorview_tabColors);
    ...
    public void testAlphaJustification()
    {
        mSolo.clickOnView(mButtonTopColor);
        mSolo.sleep(2000);
        TabHost tabHost = (TabHost) mSolo.getView(R.id.colorview_tabColors);
    ...
    public void testRGBValuesViews()
    {
        ...
        assertEquals("The layout_gravity is not CENTER_VERTICAL|end",mRedTextView.getGravity(),expected);
        assertEquals("The layout_gravity is not CENTER_VERTICAL|end",mGreenTextView.getGravity(),expected);
        assertEquals("The layout_gravity is not CENTER_VERTICAL|end",mBlueTextView.getGravity(),expected);
        assertEquals("The layout_gravity is not CENTER_VERTICAL|end",mAlphaTextView.getGravity(),expected);
    ...
    //Test View in colorpicker_dialog.xml
    ...
    public void testDoneIsMissing()
    {
        mSolo.clickOnView(mButtonTopColor);
        mSolo.sleep(2000);
        assertTrue("In rgb tab the red string is Missing", mSolo.searchText(mSolo.getString(R.string.done)));
    }
    ...
    public void testViewDoneLayout()
    {
        ...
        assertEquals("Button Done is not in the Center",mButton.getGravity(),expected);
        mSolo.goBack();

    }

    public void testRedTextRTLDirection()
    {
        mSolo.clickOnView(mButtonTopColor);
        mSolo.sleep(2000);
        TabHost tabHost = (TabHost) mSolo.getView(R.id.colorview_tabColors);
        ...
        mSolo.sleep(500);
        mRedTextView= (TextView) mSolo.getView(R.id.color_rgb_textview_red);
        // The paragraph direction of this view is Right to Left. Constant Value: 1
        assertEquals("The Direction of Red TextView is Left-to-Right",mRedTextView.getLayoutDirection(),1);
        mSolo.goBack();
    }

    public void testGreenTextRTLDirection()
    {
        mSolo.clickOnView(mButtonTopColor);
        mSolo.sleep(2000);
        TabHost tabHost = (TabHost) mSolo.getView(R.id.colorview_tabColors);
        ...
        mGreenTextView= (TextView) mSolo.getView(R.id.color_rgb_textview_green);
        // The paragraph direction of this view is Right to Left. Constant Value: 1
        assertEquals("The Direction of Green TextView is Left-to-Right",mGreenTextView.getLayoutDirection(),1);
        mSolo.goBack();

    }

    public void testBlueTextRTLDirection()
    {
        mSolo.clickOnView(mButtonTopColor);
        mSolo.sleep(2000);
        TabHost tabHost = (TabHost) mSolo.getView(R.id.colorview_tabColors);
        ...
        mBlueTextView= (TextView) mSolo.getView(R.id.color_rgb_textview_blue);
        // The paragraph direction of this view is Right to Left. Constant Value: 1
        assertEquals("The Direction of Blue TextView is Left-to-Right",mBlueTextView.getLayoutDirection(),1);
        mSolo.goBack();
    }

    public void testAlphaTextRTLDirection()
    {
        mSolo.clickOnView(mButtonTopColor);
        mSolo.sleep(2000);
        TabHost tabHost = (TabHost) mSolo.getView(R.id.colorview_tabColors);
        ...
        mAlphaTextView= (TextView) mSolo.getView(R.id.color_rgb_textview_alpha);
        // The paragraph direction of this view is Right to Left. Constant Value: 1
        assertEquals("The Direction of Alpha TextView is Left-to-Right",mAlphaTextView.getLayoutDirection(),1);
        mSolo.goBack();
    }
    ...
    public void testSeekBarDirection()
    {
        ...
        assertEquals("The Direction of Red SeekBar is Left-to-Right",mRedSeekBar.getLayoutDirection(),View.LAYOUT_DIRECTION_RTL);
